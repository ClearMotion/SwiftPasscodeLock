...
open class PasscodeLockPresenter {
    ...
    public convenience init(mainWindow window: UIWindow?, configuration: PasscodeLockConfigurationType) {
        ...
        let passcodeLockVC = PasscodeLockViewController(state: .enterPasscode, configuration: configuration, animateOnDismiss: true)
    ...
    open func presentPasscodeLock() {
        ...
        let passcodeLockVC = PasscodeLockViewController(state: .enterPasscode, configuration: passcodeConfiguration, animateOnDismiss: true)
