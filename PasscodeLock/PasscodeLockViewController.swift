...
open class PasscodeLockViewController: UIViewController, PasscodeLockTypeDelegate {
    ...
    public enum LockState {
        ...
        func getState() -> PasscodeLockStateType {
            ...
            case .changePasscode: return ConfirmPasscodeState()
    ...
    @IBOutlet open weak var visualEffectView: UIVisualEffectView!
    
    open var successCodeCallback: ((_ lock: PasscodeLockType, _ code: String) -> Void)?
    ...
    public init(state: PasscodeLockStateType, configuration: PasscodeLockConfigurationType, animateOnDismiss: Bool) {
    ...
    public convenience init(state: LockState, configuration: PasscodeLockConfigurationType, animateOnDismiss: Bool) {
    ...
    open func passcodeLockDidSucceedWithCode(_ lock: PasscodeLockType, code: String) {
